...
This program was a fun way for me to learn about handling user keypresses, using the random class, and using the pygame library to draw bullets, stars, and spaceships on the screen. Making this program also taught me an important lesson about NOT altering a list or array which I am simultaneously iterating over :-).
